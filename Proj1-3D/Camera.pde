...
class Camera
{
  Camera()
  {
    position      = new PVector( 308.16296, 895.7061, 549.8198); // initial position
    theta         = -0.0027279737; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = 0.87175286; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 100;
